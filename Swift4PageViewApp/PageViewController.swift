...
class PageViewController: UIPageViewController, UIPageViewControllerDataSource  {
    ...
    func getSecond() -> SecoundViewController {
        return storyboard!.instantiateViewController(withIdentifier: "SecoundViewController") as! SecoundViewController
    }
    ...
    func pageViewController(_ pageViewController: UIPageViewController, viewControllerBefore viewController: UIViewController) -> UIViewController? {
        ...
        } else if viewController.isKind(of: SecoundViewController.self) {// 現在のviewControllerがSecondViewControllerかどうか調べる
            // 2 -> 1
            return getFirst()
    ...
    func pageViewController(_ pageViewController: UIPageViewController, viewControllerAfter viewController: UIViewController) -> UIViewController? {
        ...
        } else if viewController.isKind(of: SecoundViewController.self) {//　現在のviewControllerがSecondViewCotrollerかどうか調べる
            // 2 -> 3
            return getThird()
